...
$user_mod_path = $app->getLibPath('user_mod');
if(!empty($user_mod_path))
{
    require_once("$user_mod_path/module.php");
    UserModule::load($user_mod_path);
}

//require_path($app->getLibPath('user_mod')."/lib/php/");
